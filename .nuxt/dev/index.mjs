...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getRequestURL, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/devalue/index.js';
import destr from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/vue/index.mjs';
import { basename } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/@iconify/utils/lib/index.mjs';
import { hash } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/unstorage/drivers/fs.mjs';
import { collections } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/.nuxt/nuxt-icon-server-bundle.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/node_modules/@unhead/shared/dist/index.mjs';
...
const _rH6hs6oFvY = (function(nitro) {
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\JustinGreen\\Desktop\\Smokey-Dev\\master-tools","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\JustinGreen\\Desktop\\Smokey-Dev\\master-tools\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\JustinGreen\\Desktop\\Smokey-Dev\\master-tools\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\JustinGreen\\Desktop\\Smokey-Dev\\master-tools\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\JustinGreen\\Desktop\\Smokey-Dev\\master-tools\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _H3JSZ1 = defineCachedEventHandler(async (event) => {
...
const _lazy_qvyZPc = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_qvyZPc, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _H3JSZ1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_qvyZPc, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/JustinGreen/Desktop/Smokey-Dev/master-tools/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
